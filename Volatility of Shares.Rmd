...
A drawdown chart is used to display the worst time for a portfolio under analysis. The charts below display the peak-to-trough decline in each of the indexes value. 
