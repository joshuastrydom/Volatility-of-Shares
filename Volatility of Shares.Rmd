...
```{r Figure8, warning =  FALSE, fig.align = 'center', fig.cap = "Rolling Annualised Standard Deviation of the Indexes \\label{Figure8}", fig.height = 5, fig.width = 6, fig.ext = 'png'}
...
```{r Figure9, warning =  FALSE, fig.align = 'center', fig.cap = "Rolling Correlation Comparison of the Indexes \\label{Figure9}", fig.height = 5, fig.width = 6, fig.ext = 'png'}
