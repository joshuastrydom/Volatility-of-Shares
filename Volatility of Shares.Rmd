...
plotreturn <- full_return |> 
    ...
    labs(title = "Rolling 3 Year Annualized Returns of large, mid and small cap Indices with differing start dates", 
...
```{r Figure7, warning =  FALSE, fig.align = 'center', fig.cap = "Rolling Annualised Returns of the Indexes \\label{Figure7}", fig.height = 3, fig.width = 6, fig.ext = 'png'}
...
full_SD <- roll_SD(l_caps, m_caps, s_caps) |> 
    ggplot() +
        ...
        labs(title = "Rolling 3 Year Annualized SD of Large, Mid and Small cap Indices with differing starting dates", subtitle = "", x = "", y = "Rolling 3 year Returns (Ann.)", caption = "Note:\nDistortions are not evident now.") + 
...
```{r Figure8, warning =  FALSE, fig.align = 'center', fig.cap = "Rolling Annualised Standard Deviation of the Indexes \\label{Figure8}", fig.height = 3, fig.width = 6, fig.ext = 'png'}
